    ...
    while (running)
    {
        ...
        switch (choice)
        {
            ...
            case 3: // 3. COMPARE TWO STOCKS
            {
                ...
                std::cout << "Enter Stock A Ticker: "; std::cin >> tickerA;
                std::cout << "Price A: $"; std::cin >> priceA;
                std::cout << "Volatility A %: "; std::cin >> volA;

                std::cout << "\nEnter Stock B Ticker: "; std::cin >> tickerB;
                std::cout << "Price B: $"; std::cin >> priceB;
                std::cout << "Volatility B %: "; std::cin >> volB;

                std::cout << "\nEnter simulations for comparison: "; std::cin >> sims;
                std::cout << "Enter trading days for comparison: "; std::cin >> days;
